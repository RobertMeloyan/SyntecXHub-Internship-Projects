...
![Internship](https://img.shields.io/badge/SyntecXHub-Virtual%20Internship-6A0DAD)
...
This is a **hands-on project assigned during the SyntecXHub Virtual Internship** program, completed to apply and demonstrate practical skills in data analysis and machine learning using real-world-style data.
...
This project was completed by **Robert Meloyan** as part of the **SyntecXHub Virtual Internship** program. Special thanks to **SyntecXHub** for the opportunity and guidance throughout this hands-on learning experience.

---

<p align="center">Made with ❤️ by <strong>Robert Meloyan</strong> and <code>scikit-learn</code></p>
<p align="center">Completed as part of the <strong>SyntecXHub Virtual Internship</strong></p>
